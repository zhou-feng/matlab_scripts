...
%   ***Note, the CompCor regressors are included in a wrong way (FZ added this message; see bellow for details)***
%  
%
...
%
% 12/24/2021: Feng Zhou fixed a bug related to the calculation of FD and another one in calculating motion 24,
...
%             FZ fixed a big in computing 24 motion regs (i.e., using the fmriprep style)
...
mo_sq = motion .^ 2;
% mo_sq_diff = [zeros(1,6); diff(mo_sq)]; % this was wrong, see Satterthwaite 2013
% motion24 = [motion diffs mo_sq mo_sq_diff];
mo_diff_sq = diffs.^2; % in line with fMRIPREP counfound regressors
motion24 = [motion diffs mo_sq mo_diff_sq];
...
% considering to use a cutoff of 1.5 for standard DVARS instead (see e.g., https://fmriprep.org/en/stable/outputs.html; FZ edited)
if dvars
...
% see https://fmriprep.org/en/stable/outputs.html
% I'm not a fan of CompCor, if you're using it please also include the cosine regressors bellow
if aCompCor
